...
// Custom lightweight replacement for the premium GSAP SplitText plugin
class GSAPSplitText {
  constructor(element, options = {}) {
    ...
    // Split content by whitespace chunks to build word containers and maintain character lists
    const wordsArray = text.split(/(\s+)/);
    
    wordsArray.forEach((wordText) => {
      if (/^\s+$/.test(wordText)) {
        // For whitespace, create a spacer element to hold spacing structure
        const spaceSpan = document.createElement('span');
        spaceSpan.className = options.wordsClass || 'shuffle-word';
        spaceSpan.style.display = 'inline-block';
        spaceSpan.innerHTML = wordText.replace(/ /g, '&nbsp;');
        element.appendChild(spaceSpan);
        this.words.push(spaceSpan);
  ...
  useGSAP(
    () => {
      ...
      if (userHasFont) {
        ...
        computedFont = `'Playfair Display', serif`;
      }
